...
const Hero = () => {
  return (
    <div className='flex w-full min-h-[70vh] bg-slate-100 max-lg:flex-col'>
      
      <div className=' bg-card-background flex-1 m-10 rounded-3xl p-12'>
        <h2 className='text-8xl font-palanquin max-lg:text-4xl'>Welcome to Clean Energy Solutions</h2>
